#version 450
// filter/sharpen — ported from wgsl/sharpen.wgsl. 3x3 sharpen convolution that
// enhances edges and detail (kernel center 5, axial neighbours -1).
...
void main() {
	...
	// Sharpen kernel
	float kernel[9] = float[9](-1.0, 0.0, -1.0, 0.0, 5.0, 0.0, -1.0, 0.0, -1.0);
