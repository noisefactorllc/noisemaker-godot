#version 450
// render/pointsRender — program "diffuse" (decay the persistent trail each frame).
// Ported from glsl/diffuse.glsl. intensity=100 means no decay, 0 means instant fade.
