#version 450
// render/pointsBillboardRender — program "copy" (blit trail to itself for ping-pong
// correction; synchronises both double-buffers so the additive deposit accumulates onto the
// faded trail). Ported from glsl/copy.glsl.
